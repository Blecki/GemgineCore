...
namespace Box2D.XNA
{
    ...
    public class Contact
    {
        ...
        internal static ContactType[,] s_registers = new ContactType[,] 
        {
            ...
            { 
              ContactType.EdgeAndCircle, 
              ContactType.Invalid,  // 1,1 is invalid (no ContactType.Edge)
              ContactType.EdgeAndPolygon,
              ContactType.Invalid, // 1,3 is invalid (no ContactType.EdgeAndLoop)
            },
            { 
              ContactType.PolygonAndCircle, 
              ContactType.EdgeAndPolygon,
            ...
            { 
              ContactType.LoopAndCircle, 
              ContactType.Invalid,  // 3,1 is invalid (no ContactType.EdgeAndLoop)
              ContactType.LoopAndPolygon,
              ContactType.Invalid, // 3,3 is invalid (no ContactType.Loop)
            },
        };
