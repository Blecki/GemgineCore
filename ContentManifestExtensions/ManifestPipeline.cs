...
namespace ContentManifestExtensions
{
    ...
    public class ManifestProcessor : ContentProcessor<string, Manifest>
    {
        public override Manifest Process(string input, ContentProcessorContext context)
        {
            ...
            foreach (var asset in compiledAssets)
            {
                ...
                else
                {
                    ...
                    if (Importer == "TextureImporter") entry.Type = ContentType.Texture;
                }
            ...
            foreach (var F in copiedAssetFiles)
                manifest.Entries.Add(new Entry { Type = ContentType.Unknown, Name = F });
